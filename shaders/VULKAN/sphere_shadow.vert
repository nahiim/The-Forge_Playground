...
#line 1 "C:/Dev/FORGE_TEMPLATE/shaders/FSL/ShaderList.fsl"
#line 18 "C:/Dev/FORGE_TEMPLATE/shaders/FSL/ShaderList.fsl"
#line 1 "C:/Dev/FORGE_TEMPLATE/shaders/FSL/sphere_shadow.vert.fsl"
#line 1 "C:/Dev/FORGE_TEMPLATE/shaders/FSL/sphere_resource.fsl"
...
#define _GetlightProjView lightProjView
#line 15
    DATA(float4x4, lightProjView, None);

#define _GettoWorld toWorld
#line 17
    DATA(float4x4, toWorld[ 768 ], None);
#define _Getcolor color
#line 18
    DATA(float4, color[ 768 ], None);
};
...
layout(location = 1) out(float2) out_VSOutput_LightmapPos;
layout(location = 2) out(float) out_VSOutput_LightmapHeight;
#line 34
#line 2 "C:/Dev/FORGE_TEMPLATE/shaders/FSL/sphere_shadow.vert.fsl"
...
//    INIT_MAIN;
...

    {
    	...
    	out_VSOutput_LightmapPos = out_VSOutput.LightmapPos;
    	out_VSOutput_LightmapHeight = out_VSOutput.LightmapHeight;
    	return;
    }
#line 12
//    RETURN(Out);
}
#line 19 "C:/Dev/FORGE_TEMPLATE/shaders/FSL/ShaderList.fsl"
